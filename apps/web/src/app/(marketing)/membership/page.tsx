        ...
        <CardContent className="flex flex-col gap-4 p-10">
          <div className="flex flex-col gap-8">
            <div className="flex flex-col gap-2">
              ...
              <h1 className="text-3xl font-bold text-foreground">Join BOMY</h1>
              <p className="text-sm leading-relaxed text-muted-foreground">
                Annual membership — shop across all BOMY stores, receive exclusive perks, and unlock
                a Welcome Gift delivered to your door.
              </p>
            </div>

            <div className="flex flex-col gap-1 rounded-xl bg-amber-50 px-6 py-5">
              <p className="text-4xl font-bold text-amber-600">{priceDisplay}</p>
              <p className="text-xs text-amber-700">billed annually · cancel anytime</p>
            </div>
          ...
          <p className="text-xs text-muted-foreground">Payment processed securely · MYR</p>
        </CardContent>
      </Card>
    </main>
  )
