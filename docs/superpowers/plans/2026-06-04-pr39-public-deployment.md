...
This task maps 1:1 to spec §11 commit 4: `docs(runbooks): public deployment cutover for bomy.my`.
...
git commit -m "$(cat <<'EOF'
docs(runbooks): public deployment cutover for bomy.my
