...
| ------------------------------- | --- | --------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `InventoryReservationExpiryJob` | #30 | Every 10 min    | Release expired active reservations; restore stock; release voucher; expire/cancel session. Grace period: 5 min after `expires_at`. Skip if session already `paid`.                                                  |
