...
One-time procedures that have finished executing. Kept for institutional knowledge and as templates for similar future work (e.g. migrating/transferring other client projects), not as active runbooks. Links committed execution evidence where it exists — several were executed without one, not because they predate the convention.

| Runbook                                                          | Completed                                                                                                                                                                                    | Evidence                                                                                                                                                  |
| ---------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [`public-deployment-cutover.md`](./public-deployment-cutover.md) | 2026-06-17                                                                                                                                                                                   | No evidence artifact committed.                                                                                                                           |
| [`magic-link-activation.md`](./magic-link-activation.md)         | 2026-06-20                                                                                                                                                                                   | No evidence artifact committed.                                                                                                                           |
| [`admin-custom-domain.md`](./admin-custom-domain.md)             | 2026-06-22 — **hosting half later superseded 2026-07-21** by `admin-vercel-migration.md` (domain now points at Vercel, not Railway); its Cloudflare/OAuth setup facts remain valid reference | No evidence artifact committed.                                                                                                                           |
